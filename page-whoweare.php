        ...
        <div class="wwa-value-grid">
            <div class="wwa-value-grid-item">
                <div class="wwa-grid-item-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#0066dd" viewBox="0 0 256 256">
            ...
            <div class="wwa-value-grid-item">
                <div class="wwa-grid-item-content">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#ffd600" viewBox="0 0 256 256">
...
<section class="wwa-greeting-section">
    <div class="wrapper wrapper8">
        ...
        <div class="wwa-greeting">
            <p>
                전 세계 어려운 아동들을 돕기 위해 시작된 라이프오브더칠드런은 올해로 11년차가 되었습니다. 작은 시냇물이 큰 강을 이루듯, 후원자 여러분의 작은 정성이 모여 어느덧 총 21개국 국가를
                ...
                더욱 희망찬 소식은, 한 아이를 향한 후원자님의 사랑이 그 아이에게 전달되고, 나중에 아이가 그 사랑을 다시 누군가에게 나누는 선순환을 일으키고 있다는 것입니다. 이는 모든 후원자님들의
                응원과 지지로 함께 해주셨기에 가능한 일이었습니다. 후원자님이 있기에 누구보다
                행복한 우리 아이들임을 기억해 주시길 바라며, 언제나 세계 곳곳의 수많은 아동들의 목소리에 귀 기울여 주시면 감사하겠습니다. 저희 또한 매 순간마다 아동의 존엄성을 지키기 위해 온 힘을
                다할 것을 약속드립니다.
