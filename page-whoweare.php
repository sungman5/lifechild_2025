...
<main id="whoweare-page">
    ...
    <section class="wwa-value gray-bg" id="action-values">
        <div class="wrapper wrapper8">
            <div class="section-header">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#000000" viewBox="0 0 256 256">
    ...
    <section class="greeting-section">
        <div class="wrapper8">
            ...
            <div class="greeting">
                <img class="greeting-img" src="<?php echo get_template_directory_uri() ?>/img/photo-by-lc-chairman.jpg"
                     alt="">
                <div class="greeting-body">
                    <p>안녕하십니까, 라이프오브더칠드런 이사장 권호경입니다.</p>
                    <p>
                        전 세계 어려운 아동들을 돕기 위해 시작된 라이프오브더칠드런은 올해로 <?php echo date('Y') - 2015 + 1 ?>년차가 되었습니다. 작은 시냇물이 큰 강을
                        이루듯, 후원자 여러분의 작은 정성이 모여 어느덧 총 21개국 국가를 지원 하는 NGO 단체로 성장하게 되었습니다.
                    </p>
                    <p>
                        라이프오브더칠드런은 후원자, 실무자, 수혜자가 함께 만들어가는 건강한 NGO를 지향하고 있으며, 단체의 투명한 운영을 큰 가치로 생각하고
                        있습니다. 또한, 아이들이 한 생명으로서의 존엄성을 회복하고, 스스로 꿈을 품고 자라나도록 돕고 있습니다.
                    </p>
                    <p>
                        더욱 희망찬 소식은, 한 아이를 향한 후원자님의 사랑이 그 아이에게 전달되고, 나중에 아이가 그 사랑을 다시 누군가에게 나누는 선순환을 일으키고 있다는 것입니다. 이는 모든
                        후원자님들의 응원과 지지로 함께 해주셨기에 가능한 일이었습니다. 후원자님이 있기에 누구보다
                        행복한 우리 아이들임을 기억해 주시길 바라며, 언제나 세계 곳곳의 수많은 아동들의 목소리에 귀 기울여 주시면 감사하겠습니다. 저희 또한 매 순간마다 아동의 존엄성을 지키기
                        위해 온 힘을 다할 것을 약속드립니다.
                    </p>
                    <p>
                        감사합니다.
                    </p>
                ...
                <div class="greeting-signature">
                    <p>라이프오브더칠드런 이사장 <strong>권호경</strong></p>
                    <img src="<?php echo get_template_directory_uri() ?>/img/greeting_signature.png" alt="권호경">
                </div>
            </div>
        </div>
    </section>
