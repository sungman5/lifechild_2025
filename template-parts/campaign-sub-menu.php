<nav class="floating-page-menu">
    <ul class="floating-page-menu-list">
        <li class="floating-page-menu-item" data-url="/active_campaigns/">
        ...
        <li class="floating-page-menu-item" data-url="/closed_campaigns/">
        ...
        <li class="floating-page-menu-item" data-url="/campaign-report/">
