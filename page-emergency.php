    ...
    <section>
        <div class="wrapper8">
            <header class="section-header">
                ...
                <p class="section-header-desc">긴급한 현장, 당신의 후원이 실제로 도착하는 곳입니다.</p>
            </header>
    ...
    <section class="emergency-type">
        <div class="wrapper8 gray-bg">
            <header class="section-header">
                ...
                <p class="section-header-desc">현실적인 필요에 따라 가장 효과적인 방식으로 지원합니다.</p>
            </header>
    ...
    <section class="emergency-casestudy">
        <div class="wrapper8">
            <header class="section-header">
                ...
                <p class="section-header-desc">어디에, 어떻게 도착하였는지 투명하게 공개합니다.</p>
            </header>
